...
sealed interface TransactionDetailUiIntent {
    object LoadDetail : TransactionDetailUiIntent
}

sealed interface TransactionDetailUiSideEffect {
    object NavigateBack : TransactionDetailUiSideEffect
}
